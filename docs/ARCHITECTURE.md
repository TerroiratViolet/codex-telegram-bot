...
用户授权图必须保持 Terroir 的一致身份特征：年轻亚洲女性、紫色头发、紫罗兰颈部纹身、
金色 `Terroir` 领章、温暖而神秘的紫罗兰场景。生成或替换图片时必须人工确认手部：

- 所有可见手掌和手指都应是与脸部一致的自然肤色。
- 不允许出现黑色的手、黑色手套、暗色手套、金属色手、墨色手或任何深色手部遮盖。
- 不允许用袖口、阴影或构图遮住伸出的邀请手。
- 若生成结果违反以上任一规则，不能替换项目资产，必须重新生成后再次确认。
